...
$strresource     = get_string('modulename', 'sadkofile');
$strresources    = get_string('modulenameplural', 'sadkofile');
$strsectionname  = get_string('sectionname', 'format_'.$course->format);
$strname         = get_string('name');
$strintro        = get_string('moduleintro');
$strlastmodified = get_string('lastmodified');

$PAGE->set_url('/mod/sadkofile/index.php', array('id' => $course->id));
...
if (!$resources = get_all_instances_in_course('sadkofile', $course)) {
...
foreach ($resources as $resource) {
    ...
    $table->data[] = array (
        ...
        format_module_intro('sadkofile', $resource, $cm->id));
}
