...
/**
 * External mod_sadkofile functions unit tests
 *
 ...
 * @since      Moodle 3.0
 */
class mod_sadkofile_external_testcase extends externallib_advanced_testcase {
    ...
    public function test_view_resource() {
        ...
        try {
            mod_sadkofile_external::view_resource(0);
            $this->fail('Exception expected due to invalid mod_sadkofile instance id.');
        ...
        $this->setUser($user);
        try {
            mod_sadkofile_external::view_resource($resource->id);
        ...
        $result = mod_sadkofile_external::view_resource($resource->id);
        $result = external_api::clean_returnvalue(mod_sadkofile_external::view_sadkofile_returns(), $result);
    ...
    /**
     * Test test_mod_sadkofile_get_resources_by_courses
     */
    public function test_mod_sadkofile_get_resources_by_courses() {
        global $DB;
        ...
        $resource1 = self::getDataGenerator()->create_module('sadkofile', $record);

        // Second resource.
        $record = new stdClass();
        $record->course = $course2->id;
        $resource2 = self::getDataGenerator()->create_module('sadkofile', $record);
        ...
        $returndescription = mod_sadkofile_external::get_resources_by_courses_returns();
        ...
        $result = mod_sadkofile_external::get_resources_by_courses(array($course2->id, $course1->id));
        ...
        $result = mod_sadkofile_external::get_resources_by_courses();
        $result = external_api::clean_returnvalue($returndescription, $result);
        ...
        $result = mod_sadkofile_external::get_resources_by_courses(array($course2->id));
