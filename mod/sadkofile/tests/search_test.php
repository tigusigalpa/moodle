 ...
 * @license     http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class mod_sadkofile_search_testcase extends advanced_testcase {
    ...
    public function setUp() {
        ...
        $this->resourceareaid = \core_search\manager::generate_areaid('mod_sadkofile', 'activity');
    ...
    public function test_attach_files() {
        ...
        $resource = $this->getDataGenerator()->create_module('sadkofile', $record);

        $searcharea = \core_search\manager::get_search_area($this->resourceareaid);
        $this->assertInstanceOf('\mod_sadkofile\search\activity', $searcharea);
