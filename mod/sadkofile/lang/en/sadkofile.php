...
/**
 * Strings for component 'sadkofile', language 'en', branch 'MOODLE_20_STABLE'
 *
...
$string['sadkofile:addinstance'] = 'Add a new resource';
$string['sadkofilecontent'] = 'Files and subfolders';
$string['sadkofiledetails_sizetype'] = '{$a->size} {$a->type}';
$string['sadkofiledetails_sizedate'] = '{$a->size} {$a->date}';
$string['sadkofiledetails_typedate'] = '{$a->type} {$a->date}';
$string['sadkofiledetails_sizetypedate'] = '{$a->size} {$a->type} {$a->date}';
$string['sadkofile:exportresource'] = 'Export resource';
$string['sadkofile:view'] = 'View resource';
